...
~~~
!@NetOps
ip route add 10.0.0.0/8 via 10.21.1.4
ip route add 200.0.0.0/24 via 10.21.1.4
~~~
...
- Subject Alt Names:                         rivan.com  www.rivan.com  api.rivan.com  10.21.1.6
...
Review: Create a DNS A record for www.ccna21.com
...
1. Make the www.rivan21.com accessible via port 8080
